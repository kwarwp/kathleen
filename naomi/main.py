...
HOMEM = "https://3.bp.blogspot.com/-xsgQSKi0xHg/V1IMCh9vlqI/AAAAAAAAEDw/S81m4JHTNdYOrdQvm_GLEXt2eqVr8NoNgCLcB/s1600/pngg.png"
...
class OI ():
		#def _init_main (self)
		 homem = Cena (img= HOMEM)
		 boneca = Elemnento (img= BONECA)
            boneca.entra(homem)
            boneca.vai()
class OI 