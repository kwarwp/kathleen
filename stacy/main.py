...
class alunos():
    def __init__ (self):
        ...
        garca1 = Elemento(img=GARCA1, tit"modificada", style=dict(
                        left=102, top=11, width=60, height="60px")) 
        garca2 = Elemento(img=GARCA2, tit"modificada", style=dict(
                        left=90, top=12, width=60, height="60px")) 
        garca3 = Elemento(img=GARCA3, tit"modificada", style=dict(
                        left=109, top=15, width=60, height="60px")) 
